    ...
    try:
        ...
        if not heatmap_data_numeric.empty:
            fig = px.imshow(
                ...
                color_continuous_scale=px.colors.sequential.Teal, # Or 'Hot', 'Viridis', etc.
            ...
            fig.update_xaxes(side="bottom", tickangle=90) # Move crime type labels to the bottom for better readability
            fig.update_layout(
